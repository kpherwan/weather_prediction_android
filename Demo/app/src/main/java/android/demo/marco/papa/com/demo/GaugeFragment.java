...
public class GaugeFragment extends Fragment {
    ...
    public GaugeFragment(int cloudCover, int precipitation, int humidity) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        HIChartView chartView = view.findViewById(R.id.hc2);
        ...
        paneBackground1.setBackgroundColor(HIColor.initWithRGBA(192, 223, 153, 0));
        ...
        paneBackground2.setBackgroundColor(HIColor.initWithRGB(192, 222, 255));
        ...
        paneBackground3.setBackgroundColor(HIColor.initWithRGBA(245, 195, 183, 0.35));
        ...
        plotOptions.getSolidgauge().setOpacity(0.8);
        ...
        data1.setColor(HIColor.initWithRGBA(85, 160, 3, 0.8));
        solidgauge1.setOpacity(0.8);
        data1.setRadius("112%");
        ...
        data2.setColor(HIColor.initWithRGBA(84, 168, 255, 0.8));
        data2.setRadius("87%");
        solidgauge2.setOpacity(0.8);
        ...
        data3.setColor(HIColor.initWithRGB(236, 111, 82));
        data3.setRadius("62%");
